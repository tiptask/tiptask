      ...
      <main className="min-h-screen bg-[#08080C] text-white flex flex-col items-center justify-center px-6 pt-20 pb-10 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md w-full">
          ...
          <p className="text-white/50 text-lg mb-3 leading-relaxed">
            The live monetization platform with the lowest fees online — only 15% per transaction, down to 5% on premium.
          </p>
          <p className="text-white/25 text-sm mb-10">
            For streamers, DJs, fitness instructors, and live creators.
          </p>
